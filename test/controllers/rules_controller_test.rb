...
class RulesControllerTest < ActionController::TestCase
  ...
  test "should create rule" do
    assert_difference('Rule.count') do
      post :create, rule: { active: @rule.active, notifies: @rule.notifies, wallet_id: @rule.wallet_id }
    end
  ...
  test "should update rule" do
    patch :update, id: @rule, rule: { active: @rule.active, notifies: @rule.notifies, wallet_id: @rule.wallet_id }
    assert_redirected_to rule_path(assigns(:rule))
  end
